...
class InventoryItemList
{
	...
	public static function generateInventoryItem(graphic:String, name:String, ?recipe:RecipeMap, ?maxStackSize:Null<Int>, ?id:String)
	{
		return new InventoryItem(graphic, new Item(name, maxStackSize ?? Item.GLOBAL_MAX_STACKSIZE, id), recipe ?? []);
	}
}
